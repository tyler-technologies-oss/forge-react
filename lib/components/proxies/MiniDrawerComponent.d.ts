import { MiniDrawerComponent as MiniDrawerComponentElement } from "@tylertech/forge/esm/mini-drawer";

export type { MiniDrawerComponentElement };

export interface MiniDrawerComponentProps
  extends Pick<
  ...
  direction?: MiniDrawerComponentElement["direction"];
 ...
 */
export const MiniDrawerComponent: React.ForwardRefExoticComponent<MiniDrawerComponentProps>;
