import { CardComponent as CardComponentElement } from "@tylertech/forge/esm/card";
...
export interface CardComponentProps
  extends Pick<
    ...
    | "onBlur"
  > {
  /** Whether the card has an raised or not. */
  raised?: boolean;

  /** Removes the default padding from the card. */
  noPadding?: boolean;
...
/**
 * Cards are used to group related information and actions about a single subject.
 * ---
 *
 *
 * ### **CSS Properties:**
 ...
 */
export const CardComponent: React.ForwardRefExoticComponent<CardComponentProps>;
