import { ModalDrawerComponent as ModalDrawerComponentElement } from "@tylertech/forge/esm/modal-drawer";

export type { ModalDrawerComponentElement };

export interface ModalDrawerComponentProps
  extends Pick<
  ...
  direction?: ModalDrawerComponentElement["direction"];
  ...
  /** Dispatched when the modal drawer is closed by clicking the backdrop. */
  onForgeModalDrawerClose?: (event: CustomEvent<CustomEvent<void>>) => void;
 ...
 */
export const ModalDrawerComponent: React.ForwardRefExoticComponent<ModalDrawerComponentProps>;
