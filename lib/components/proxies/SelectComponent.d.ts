import { SelectComponent as SelectComponentElement } from "@tylertech/forge/esm/select";

export type { SelectComponentElement };
...
export interface SelectComponentProps
  ...
  label?: SelectComponentElement["label"];

  /** Controls the placeholder text. */
  placeholder?: SelectComponentElement["placeholder"];

  /** Gets/sets the value. */
  value?: SelectComponentElement["value"];

  /** Gets/sets the selected index. */
  selectedIndex?: SelectComponentElement["selectedIndex"];

  /** The position of the label. */
  labelPosition?: SelectComponentElement["labelPosition"];

  /** The alignment of the label. */
  labelAlignment?: SelectComponentElement["labelAlignment"];

  /** The variant of the field. */
  variant?: SelectComponentElement["variant"];

  /** The theme of the field. */
  theme?: SelectComponentElement["theme"];

  /** The shape of the field. */
  shape?: SelectComponentElement["shape"];

  /** The density of the field. */
  density?: SelectComponentElement["density"];

  /** The inset of the support text. */
  supportTextInset?: SelectComponentElement["supportTextInset"];
  ...
  /** Whether the label floats above the field. */
  floatLabel?: SelectComponentElement["floatLabel"];

  /** Gets/sets the available options. */
  options?: SelectComponentElement["options"];

  /** Gets/sets the option builder function. */
  optionBuilder?: SelectComponentElement["optionBuilder"];

  /** Gets/sets the selected text builder function. */
  selectedTextBuilder?: SelectComponentElement["selectedTextBuilder"];

  /** Gets/sets the before value change callback. */
  beforeValueChange?: SelectComponentElement["beforeValueChange"];

  /** Whether the popover icon is displayed. */
  popoverIcon?: SelectComponentElement["popoverIcon"];

  /** Dispatched when the dropdown list has scrolled to the bottom. */
  onForgeSelectScrolledBottom?: (event: CustomEvent<CustomEvent<void>>) => void;

  /** Dispatched when the user selects a value. */
  onChange?: (event: CustomEvent<CustomEvent<any>>) => void;
}
 ...
 */
export const SelectComponent: React.ForwardRefExoticComponent<SelectComponentProps>;
