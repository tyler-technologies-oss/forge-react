import { TextFieldComponent as TextFieldComponentElement } from "@tylertech/forge/esm/text-field";

export type { TextFieldComponentElement };
...
export interface TextFieldComponentProps
  ...
  labelPosition?: TextFieldComponentElement["labelPosition"];

  /** The alignment of the label relative to the field. */
  labelAlignment?: TextFieldComponentElement["labelAlignment"];

  /** The variant of the field. */
  variant?: TextFieldComponentElement["variant"];

  /** The theme of the field. */
  theme?: TextFieldComponentElement["theme"];

  /** The shape of the field. */
  shape?: TextFieldComponentElement["shape"];

  /** The density of the field. */
  density?: TextFieldComponentElement["density"];

  /** The inset of the support text. */
  supportTextInset?: TextFieldComponentElement["supportTextInset"];
  ...
  popoverTargetElement?: TextFieldComponentElement["popoverTargetElement"];

  /** Dispatched when the clear button is clicked. */
  onForgeTextFieldClear?: (event: CustomEvent<CustomEvent<void>>) => void;
...
/**
 * The Forge Text Field component wraps and styles an input or textarea element.
 * ---
 *
 *
 * ### **Events:**
 ...
 */
export const TextFieldComponent: React.ForwardRefExoticComponent<TextFieldComponentProps>;
